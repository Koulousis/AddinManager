...
#region Suspension
		...
		AddinAttr odmBracketsAttr = new AddinAttr()
		{
			...
			Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Coming soon.pdf")
		};
		...
		AddinAttr takeOffMainDiametersAttr = new AddinAttr()
		{
			...
			AssemblyPath = $@"{oldDeployedDlls}\HVAC.dll",
...
#region AHU
		...
		AddinAttr ahuEditorAttr = new AddinAttr()
		{
			Name = "AHU editor",
			Title = "AHU editor",
			//AssemblyPath = $@"J:\Drawings REVIT FAMILIES\09 Projects\Addins\Mechanical\AHU\mechanical-ahu-editor\AhuEditor\bin\Debug\AhuEditor.dll",
			//ClassName = "HVAC.AHUComponents",
			AssemblyPath = $@"{deployedDlls}\AhuEditor.dll",
			...
			Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\AHU editor.pdf")
		};
...
#region Accesorries
		...
		AddinAttr insertCvdVavAttr = new AddinAttr()
		{
			...
			AssemblyPath = $@"{deployedDlls}\InsertCvdVav.dll",
			ClassName = "InsertCvdVav.Command",
...
#region Cables
			...
			AddinAttr cableLengthsAttr = new AddinAttr()
			{
				Name = "Cable lengths",
				Title = "Cable lengths",
				AssemblyPath = $@"{oldDeployedDlls}\PETAddin.dll",
				...
				Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Cable lengths.pdf")
			};
...
#region Markers
			...
			AddinAttr createCableMarkersAttr = new AddinAttr()
			{
				...
				Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Create cable markers.mp4")
			};
...
#region Pipe splits
			...
			AddinAttr pprctSplit4mAttr = new AddinAttr()
			{
				...
				AssemblyPath = $@"{oldDeployedDlls}\Plumbing\PpRctSplit.dll",
...
#region Connections
			...
			AddinAttr flexPipeConnectionAttr = new AddinAttr()
			{
				...
				Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Flexible pipe connection.pdf")
			};
...
#region Incubators piping
			...
			AddinAttr piping2dDetailAttr = new AddinAttr()
			{
				...
				AssemblyPath = $@"{oldDeployedDlls}\Piping2DDetail.dll",
...
#region Data to compare
			...
			AddinAttr dataGridAttr = new AddinAttr()
			{
				Name = "Data grid",
				Title = "Data grid",
				AssemblyPath = $@"{oldDeployedDlls}\DataGrid.dll",
			...
			AddinAttr cableDataAttr = new AddinAttr()
			{
				...
				Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Cable data.pdf")
			};
...
#region Export data
			...
			AddinAttr translationsAttr = new AddinAttr()
			{
				Name = "Translations",
				Title = "Translations",
				AssemblyPath = $@"{oldDeployedDlls}\Translations.dll",
			...
			AddinAttr eagleEyeLayoutsAttr = new AddinAttr()
			{
				...
				Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Eagle eye layouts.pdf")
			};
...
#region Revit shortcuts
			...
			AddinAttr structureSelectorAttr = new AddinAttr()
			{
				...
				AssemblyPath = $@"{oldDeployedDlls}\StructureSelector.dll",
				...
				Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Coming soons.pdf")
			};
			...
			AddinAttr renumberDuctSystemAttr = new AddinAttr()
			{
				...
				AssemblyPath = $@"{oldDeployedDlls}\RenumberElements 2016.dll",
			...
			AddinAttr weekplanningAttr = new AddinAttr()
			{
				Name = "Weekplanning",
				Title = "Weekplanning",
				AssemblyPath = $@"{oldDeployedDlls}\Weekplanning.dll",
			...
			AddinAttr familyReadParameterAttr = new AddinAttr()
			{
				...
				AssemblyPath = $@"{oldDeployedDlls}\FamilyReadParameter.dll",
				...
				Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Family Read Parameter.pdf")
			};
			...
			AddinAttr familyUpgradeAttr = new AddinAttr()
			{
				...
				AssemblyPath = $@"{deployedDlls}\FamilyUpgrade.dll",
				...
				Help = new ContextualHelp(ContextualHelpType.Url, $@"{guidelines}\Family upgrade.pdf")
			};
